...
namespace OpenAuth.Mvc.Controllers
{
    ...
    /// 科室月度讲评得分
    /// </summary>
    public class DepartmentMonthlyEvaluationsController : BaseController
    {
        public DepartmentMonthlyEvaluationApp App { get; set; }
        ...
        [System.Web.Mvc.HttpGet]
        public ActionResult page(int limit, int offset, DepartmentMonthlyEvaluationQueryInput input)
        {
        ...
        public ActionResult save(DepartmentMonthlyEvaluation input)
        {
